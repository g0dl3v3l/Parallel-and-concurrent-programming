...
source_files = [
    "Assgn2-Chunk-EE21BTECH11015/Assgn2-Chunk-EE21BTECH11015.cpp", 
    "Assgn2-Mixed-EE21BTECH11015/Assgn2-Mixed-EE21BTECH11015.cpp", 
    "Assgn2-Dynamic-EE21BTECH11015/Assgn2-Dynamic-EE21BTECH11015.cpp"
]
...
if current_platform == "Windows":
    compile_cmd = "g++-13 {source_file} -o executable.exe -fopenmp"
    run_cmd = "executable.exe"
else:
    compile_cmd = "g++-13 {source_file} -o executable -fopenmp"
    run_cmd = "./executable"
